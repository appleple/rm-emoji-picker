...
var EmojiCategory = function () {
    ...
    _createClass(EmojiCategory, [{
        ...
        value: function filter(callback) {
            var emojis_to_hide = this.emojis.filter(function ( /**Emoji*/emoji) {
                return !callback(emoji);
            });

            emojis_to_hide.forEach(function ( /**Emoji*/emoji) {
                return emoji.$emoji.hide();
            });
        }
    }, {
        key: "showAllEmojis",
        value: function showAllEmojis() {
            this.emojis.forEach(function (emoji) {
