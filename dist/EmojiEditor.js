...
var EmojiEditor = function () {
    ...
    _createClass(EmojiEditor, [{
        ...
        value: function placeEmoji(emoji) {
            ...
            var text = this.pasteInputText(emoji.getColons());
            (0, _jquery2.default)(this._input).trigger('change').trigger('input'); //triggers change & input events since we're doing this manually
            return text;
        }
